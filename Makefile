...
QEMU = ~/local/qemu/bin/qemu-system-i386
...
CFLAGS = -fno-pic -static -fno-builtin -fno-strict-aliasing -Wall -MD -ggdb -m32 -Werror -fno-omit-frame-pointer -Wno-error=unknown-pragmas
